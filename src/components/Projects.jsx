        ...
        <HStack pb="40px" w="95%" m="auto" mt="50px">
          ...
          >
            ...
            <Text
              ...
              textAlign={"left"}
            >
              DeskTime is a time tracking tool with additional features for
              workforce management. These features can help you build a
              successful team that consistently achieves its goals.
            </Text>
            <Flex gap="10px">
              <Box
                className="project-tech-stack"
            ...
            <Flex gap="20px">
              <Link
                className="project-github-link"
                target={"_blank"}
                href="https://github.com/palabhi017/terrific-language-9890"
              >
                <Flex
                  gap="5px"
                  alignItems={"center"}
              ...
              <Link
                className="project-deployed-link"
                target={"_blank"}
                href="https://time-always.netlify.app/"
              >
                <Flex
                  gap="5px"
                  alignItems={"center"}
          ...
          <VStack className="project-card" gap={5} w="50%">
            ...
            <Flex gap="20px">
              <Link
                className="project-github-link"
                target={"_blank"}
                href="https://github.com/palabhi017/loving-friends-4004"
              >
                <Flex
                  gap="5px"
                  alignItems={"center"}
              ...
              <Link
                className="project-deployed-link"
                target={"_blank"}
                href="https://fluffy-jelly-ba9f7f.netlify.app/"
              >
                <Flex
                  gap="5px"
                  alignItems={"center"}
        ...
        <HStack pb="40px" w="95%" m="auto" mt="50px">
          ...
          >
            ...
            <Text
              ...
              textAlign={"left"}
            >
              A task management platform that allows users to organize and
              prioritize their to-do list. A comprehensive solution for tracking
            ...
            <Flex gap="20px">
              <Link
                className="project-github-link"
                target={"_blank"}
                href="https://github.com/palabhi017/bewildered-discussion-8431/tree/main/timetable"
              >
                <Flex
                  gap="5px"
                  alignItems={"center"}
              ...
              <Link
                className="project-deployed-link"
                target={"_blank"}
                href="https://time-blue.vercel.app/"
              >
                <Flex
                  gap="5px"
                  alignItems={"center"}
          ...
          <VStack className="project-card" gap={5} w="50%">
            ...
            >
              ...
              committed to making your everyday carry. You can look forward to a
              carefully-crafted range of products.{" "}
            </Text>
            <Flex gap="10px" alignItems={"left"}>
              <Box
                className="project-tech-stack"
            ...
            <Flex gap="20px">
              <Link
                className="project-github-link"
                target={"_blank"}
                href="https://github.com/HANUMAT-SHARAN/bright-noise-2667/tree/master/cw-rct201"
              >
                <Flex
                  gap="5px"
                  alignItems={"center"}
              ...
              <Link
                className="project-deployed-link"
                target={"_blank"}
                href="https://gentle-kringle-071b60.netlify.app/"
              >
                <Flex
                  gap="5px"
                  alignItems={"center"}
        ...
        <VStack pb="40px" w="90%" m="auto" mt="50px">
          <VStack gap={5} pb="10px" w="90%" borderBottom={"3px solid #2f1c6a"}>
            ...
            <Flex gap="20px">
              ...
              <Link target={"_blank"} href="https://time-always.netlify.app/">
                <Flex
                  gap="5px"
                  alignItems={"center"}
                  fontFamily={"sans-serif"}
          ...
          >
            ...
            >
              <ReadMoreReact
                text={
                  "A task management platform that allows users to organize and prioritize their to-do list. A comprehensive solution for tracking progress and meeting deadlines."
                }
                min={40}
                ideal={68}
                max={80}
            ...
            <Flex gap="20px">
              ...
              <Link target={"_blank"} href="https://time-blue.vercel.app/">
                <Flex
                  gap="5px"
                  alignItems={"center"}
                  color="#2f1c6a"
          ...
          >
            ...
            >
              <ReadMoreReact
                text={
                  "DailyObjects is a design-obsessed lifestyle accessories brand committed to making your everyday carry. You can look forward to a carefully-crafted range of products."
                }
                min={40}
                ideal={68}
                max={80}
