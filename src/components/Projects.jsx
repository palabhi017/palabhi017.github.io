...
export default function Projects(){
    ...
    return (
        <Box className="Project"  boxSizing="border-box"  w={"98%"} m="auto" h={"auto"} mt={"10px"} borderRadius="10px" bgColor="#008970">
          <Heading color="#ffe77b">
         <TypeAnimation
      sequence={[
        2000,
         "Projects",
    ...
    /> 
      ...
      <Show above="801px">
        <HStack pb="40px" w="90%" m="auto" mt="50px">
            <VStack gap={5}  w="50%" borderRight={"3px solid #ffe77b"}>
            <Heading color="white">DeskTime.com Clone</Heading>
            <Text w="80%" fontSize={"20px"} color="#ffe77b" textAlign={"left"}>DeskTime is a time tracking tool with additional features for workforce management. These features can help you build a successful team that consistently achieves its goals.</Text>
            <Flex gap="10px">
              <Box fontSize={"20px"}  fontWeight={"bold"} color="#fff">TechStack :-</Box>
              <Box border="2px solid #fff"  p="0px 5px" fontSize={"20px"} box-Shadow="rgba(0, 0, 0, 0.35) 0px 5px 15px" fontWeight={"bold"} color="#fff">HTML</Box>
              <Box border="2px solid #fff" p="0px 5px" fontSize={"20px"}  fontWeight={"bold"} color="#fff">CSS</Box>
             <Box border="2px solid #fff" p="0px 5px" fontSize={"20px"}  fontWeight={"bold"} color="#fff">JavaScript</Box>
            </Flex>
            ...
            <Text w="80%" fontSize={"20px"} color="#ffe77b" textAlign={"left"}>Chargebee is the subscription billing and revenue management platform that lets you solve for your today, and scale for your tomorrow.</Text>
            <Flex gap="10px">
              <Box fontSize={"20px"}  fontWeight={"bold"} color="#fff">TechStack :-</Box>
              <Box border="2px solid #fff"  p="0px 5px" fontSize={"20px"} box-Shadow="rgba(0, 0, 0, 0.35) 0px 5px 15px" fontWeight={"bold"} color="#fff">HTML</Box>
              <Box border="2px solid #fff" p="0px 5px" fontSize={"20px"}  fontWeight={"bold"} color="#fff">CSS</Box>
        ...
        <HStack pb="40px" w="90%" m="auto" mt="50px">
            ...
            <Text w="80%" fontSize={"20px"} color="#ffe77b" textAlign={"left"}>A task management platform that allows users to organize and prioritize their to-do list. A comprehensive solution for tracking progress and meeting deadlines.</Text>
            <Flex gap="10px">
              <Box fontSize={"20px"}  fontWeight={"bold"} color="#fff">TechStack :-</Box>
              <Box border="2px solid #fff"  p="0px 5px" fontSize={"20px"} box-Shadow="rgba(0, 0, 0, 0.35) 0px 5px 15px" fontWeight={"bold"} color="#fff">React</Box>
              <Box border="2px solid #fff" p="0px 5px" fontSize={"20px"}  fontWeight={"bold"} color="#fff">Chakra Ui</Box>
             <Box border="2px solid #fff" p="0px 5px" fontSize={"20px"}  fontWeight={"bold"} color="#fff">Render</Box>
            </Flex>
            <Box    boxShadow= "rgba(0, 0, 0, 0.80) 0px 3px 8px" w="80%">
