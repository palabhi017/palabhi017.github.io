...
export default function About(){
    ...
    return (
        ...
        <Show above="800px" >
            ...
            <Heading id="#about.about.section" p="30px" color="#693fee" fontSize={"40px"}>About Me</Heading>
            ...
            <Image id=".home-img" w={"100%"}  m="auto" borderRadius={"10px"}  src={Profilepic} alt='' />
            </Box>
            <Box w="40%">
            <VStack>
            <Box    >
                <Heading color="#693fee">Hi..</Heading>
                <Heading id="user-detail-name" color="#2f1c6a">I am Abhishek Pal</Heading>
                <Text id="user-detail-intro" mt="10px" fontSize={"23px"} color="#4f3f7d" fontWeight={"bold"}>"Full stack web developer with a passion for creating intuitive and functional web applications using a variety of technologies including HTML, CSS, JavaScript, and modern frameworks such as React and Node.js.</Text>
            </Box>
