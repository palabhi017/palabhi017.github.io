import {Box,Image,Grid,Show,Heading,Text} from "@chakra-ui/react"
...
<>
    ...
    />   </Heading>
        ...
        <Box className="skills-card" w='50%'  borderRadius={"30px"}  bg='white' boxShadow= "rgba(0, 0, 0, 0.24) 0px 3px 8px">
